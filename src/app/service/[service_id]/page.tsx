...
import NewServiceBasic from "@/components/NewServiceDetail/NewServiceBasic";
import NewServicePoint from "@/components/NewServiceDetail/NewServicePoint";
    ...
    <Wrapper>
      ...
      <div id="smooth-wrapper">
        <div id="smooth-content">
          <main>
            <div className="new-services-main container">
              <NewServiceBasic thisService={thisService} />
              <NewServicePoint thisService={thisService} />
            </div>
            <AboutHomeFour />
