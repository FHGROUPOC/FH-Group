...
const feature_data: DataType = {
  ...
  des: `Master the art of movement and storytelling with our in-depth Blender character animation course. Learn to model, rig, and animate lifelike characters using Blender.`,
  boxtitle: `Advertise`,
  box_des_1: ``,
  box_des_2: `Ads Manager tools & setup`,
  features: [
    {
      id: 1,
      title: `Animate`,
      des_1: ``,
      des_2: `Character modeling & rigging with Blender`,
    },
    {
      id: 2,
      title: `Develop`,
      des_1: ``,
      des_2: `React basics & Next.js dynamic routing`,
    },
  ],
