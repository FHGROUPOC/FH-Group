...
const feature_data: DataType = {
  subtitle: `Top Digital Training Center in Lahore`,
  title: ` Learn Blender Animation, Next.js Web Development & Meta Ads`,
  des: `At FH Group, we offer end-to-end mobile app development services with 15% OFF for a limited time. From custom UI/UX design that enhances user experience to full stack development using modern, scalable technologies, we build apps that perform. We handle App Store and Google Play submission to ensure a smooth launch, and provide reliable post-launch support and maintenance to keep your app secure and up to date.`,
  boxtitle: `Timely Delivery`,
  box_des_1: ``,
  box_des_2: `We keep you updated at every stage of development with clear timelines.
`,
  features: [
    {
      id: 1,
      title: `Expert Team`,
      des_1: ``,
      des_2: `Skilled developers, designers, and strategists bringing your app vision to life with precision.`,
    },
    {
      id: 2,
      title: `Proven Process`,
      des_1: ``,
      des_2: `A streamlined, agile workflow ensuring quality, speed, and scalability from start to finish.`,
    },
  ],

  // for home five
  subtitle_2: `Why Choose Us`,
  title_2: `Fast Turnaround with Quality Assurance.`,
};
const {
  subtitle,
  title,
...
const FeatureHomeApp = ({ style_2 }: any) => {
  return (
    <>
      ...
      <section className={`cs_shape_wrap_3 ${style_2 ? "cs_gray_bg_20" : ""}`}>
        ...
        <div className="container">
          <div
            className={`row ${
              style_2 ? "flex-column flex-lg-row align-items-center pb-5" : ""
            }`}
          >
            <div className="col-lg-8 col-12">
              ...
              <div className="d-flex gap-4 align-items-center flex-wrap flex-lg-nowrap justify-content-center thr-sec-flex">
                <div className="anim_text para-width-max">
                  <p className="cs_font_16 cs_secend_section">{des}</p>
                  {/* <div className="cs_service_back_btn">
                    <a href="/contact" className="cs_style_1 cs_color_1">
