...
const feature_data: DataType = {
  subtitle: `Features`,
  title: `FH Group Payment Gateway Service.`,
  des: `Our payment gateway service operates on a transparent fee structure, charging a flat 3.5% on each successful transaction processed through the platform. This fee covers secure transaction handling, fraud detection protocols, real-time processing, and customer support. After the deduction of this fee, the remaining transaction amount will be transferred to the client’s designated bank account within 10 business days. This settlement cycle allows time for transaction verification, security checks, and compliance with financial protocols. All transactions and payouts are fully documented and traceable via your client dashboard for easy reconciliation and reporting.`,
  boxtitle: `Transparency`,
  box_des_1: `Award Winning Quality`,
  box_des_2: `Flat 3.4% markup with no hidden charges.`,
  features: [
    {
      id: 1,
      title: `Tracking`,
      des_1: `Award Winning Quality`,
      des_2: `Real-time visibility from initiation to completion.`,
    },
    {
      id: 2,
      title: `Support`,
      des_1: `Award Winning Quality`,
      des_2: `24/7 assistance for all transaction-related queries.`,
    },
  ],
...
const GatewayFeatureHome = ({ style_2 }: any) => {
  return (
    <>
...
export default GatewayFeatureHome;
