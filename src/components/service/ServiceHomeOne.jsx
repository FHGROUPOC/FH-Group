...
import Home_service_data from "@/data/home_service_data";
            ...
            {Home_service_data.map((item, i) => (
              ...
              >
                ...
                <Link
                  ...
                  href={"/service/" + item.linktitle?.split(" ")[0]}
                >
                  <div className="cs_card_right">
                    <div className="cs_card_right_in">
                      <h3 className="cs_card_title">{item.title}</h3>
                      <div className="cs_card_subtitle">
                        {" "}
                        {item.desc.length > 135
                          ? item.desc.substring(0, 135) + "..."
                          : item.desc}
                      </div>
                    </div>
                  </div>
