...
import Home_service_data from "@/data/fabrication_home_service_data";

const EngineeringServiceHomeOne = () => {
  return (
    <>
              ...
              >
                <div className="cs_card_left">
                  <div
                    ...
                    style={{
                      backgroundImage: `url(https://res.cloudinary.com/dgtk4rthy/image/upload/v1738056464/FHGROUPOC/FABRICATION/New/tanc2ypnnprxjpi68jrl.jpg)`,
                    }}
                  >
                    0{i + 1}
                  </div>
                ...
                <Link
                  href={"/engineering/service/" + item.linktitle?.split(" ")[0]}
                >
                  <div className="cs_card_right">
                    <div className="cs_card_right_in">
                      <h2 className="cs_card_title">{item.title}</h2>
                      <div className="cs_card_subtitle">{item.desc}</div>
                    </div>
                  </div>
                </Link>
                <div className="cs_card_link_wrap">
                  <Link
                    href={
                      "/engineering/service/" + item.linktitle?.split(" ")[0]
                    }
      ...
      <div className="cs_height_150 cs_height_lg_30"></div>
    </>
  );
};

export default EngineeringServiceHomeOne;
