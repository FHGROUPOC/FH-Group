        ...
        <div className="container">
          <div className="cs_learning_project">
            <div className="cs_section_heading cs_style_1">
              <img
                src="https://res.cloudinary.com/dgtk4rthy/image/upload/v1754569571/image_srmaev.jpg"
                alt="folder"
                width="700px"
              />
              <div className="cs_section_heading_text">
                ...
                <div className="cs_card_subtitle">
                  Choose both apps and enjoy a 12-month easy payment plan, zero
                  markup, flexible timelines, and guaranteed quality.
                </div>
                <h3 className="cs_section_title_3 anim_heading_title pt-5">
