...
const hero_data: DataType = {
  ...
  des: `We provide end-to-end medical billing services designed to help healthcare providers maximize revenue, reduce claim denials, and improve cash flow. Our expert team streamlines your revenue cycle management (RCM) process—from patient registration to final payment—ensuring timely and accurate reimbursements for hospitals, clinics, and private practices.`,
  social_links: [
    {
      id: 1,
      img: facebook,
...
export default MedicalHeroHomeFour;