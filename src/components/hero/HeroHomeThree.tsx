...
const hero_data: DataType = {
  title_1: `Bring Characters to Life with FH Group's Expert Animation Services`,
  links: [{ title: "Facebook" }, { title: "Behance" }, { title: "Dribbble" }],
};
const { title_1, links } = hero_data;
      ...
      <section>
        <div className="cs_hero cs_style2">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://res.cloudinary.com/dgtk4rthy/image/upload/v1735226863/FHGROUPOC/CARTOON_ANIMATION/gh1z30csqihlfq7yiig2.jpg)",
            }}
          ></div>
          ...
          <div className="container">
            <div className="cs_hero_text">
              <div className="anim_banner_text_left">
                <h1 className="cs_hero_title cs_hero_title_lg color_white lh-1">
                  {title_1}
                </h1>
              </div>
