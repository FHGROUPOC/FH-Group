...
const title = `Your Trusted Partner for Custom Engineering Solutions`;
    ...
    <>
      <div className="cs_moving_section_wrap cs_bold cs_primary_bg py-4">
        <div className="cs_moving_section_in">
          <h4 className="cs_moving_section mb-0 cs_white_color mx-2">
            {title}&nbsp;
            <span className="cs_accent_color">&bull; {title} &bull;</span>{" "}
            &nbsp; {title}
            <span className="cs_accent_color mx-2">&bull; {title} &bull;</span>
          </h4>
