    ...
    const handleSubmit = async (event: any) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const sendmail = await fetch("/api/nodemailer", {
            method: "POST",
        ...
        <div className="cs_contact_ms">
                ...
                <div className="row">
                  ...
                  <div className="cs_field_group col">
                    ...
                    >
                      ...
                      <option value="CUSTOM Engineering">
                        CUSTOM Engineering
                      </option>
                      <option value="METAL Engineering">
                        METAL Engineering
                      </option>
                      <option value="STRUCTUAL Engineering">
                        STRUCTUAL Engineering
                      </option>
                      <option value="PRECISION Engineering">
                        PRECISION Engineering
                      </option>
                      <option value="ON-SITE INSTALLATION">
          ...
          <div className="cs_contact_section_2 anim_div_ShowRightSide">
            ...
            <div className="row">
              ...
              <div
                className="cs_google_map cs_bg center gap-2"
                data-src="assets/img/map_img.png"
              >
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3612.8457732587876!2d55.19615097696035!3d25.107081535342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6b7af47fdcf5%3A0x5e1780e9803c797f!2sRasis%20Business%20Center!5e0!3m2!1sen!2s!4v1734005415411!5m2!1sen!2s"
                  allowFullScreen
                ></iframe>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3403.1255161382805!2d74.26597717706942!3d31.465733249836973!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39190166d81086b7%3A0x53770bcabec44425!2sFH%20Enterprise%20%26%20PVT%20Limited!5e0!3m2!1sen!2s!4v1734005237412!5m2!1sen!2s"
                  allowFullScreen
                ></iframe>
              </div>
              <div className="cs_height_50 cs_height_lg_50"></div>
                ...
                <div className="cs_icon">
                  ...
                  <div className="cs_icon_text">
                    ...
                    <p className="cs_icon_subtitle">
                      4th Floor, Al-Rasis Center, Al Baraha Street # 1, Sector,
                      Dubai-UAE
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-3">
                <div className="cs_icon">
                  <a href="tel:+971521417285" className="cs_icon_style">
                    <i>
                      <svg
                        width="13"
                        height="19"
                  ...
                  <a href=" tel:+971521417285">
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">+97 152 141 7285</p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="col-md-3">
                <div className="cs_icon">
                  <a href="tel:+923314447077" className="cs_icon_style">
                    <i>
                      <svg
                        width="13"
                        height="19"
                  ...
                  <a href="tel:+923314447077">
                    <div className="cs_icon_text">
                      <h6 className="cs_icon_title">Phone</h6>
                      <p className="cs_icon_subtitle">+92 331 444 7077</p>
                    </div>
                  </a>
                </div>
              </div>
              <div className="col-md-3">
                <div className="cs_icon">
                  <a href="mailto:info@fhgroupoc.com" className="cs_icon_style">
                    <i>
                      <svg
                        width="13"
                        height="14"
                  ...
                  <a href="mailto:info@fhgroupoc.com">
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">info@fhgroupoc.com</p>
                    </div>
                  </a>
                </div>
              </div>
...
export default EngineeringContactArea;
