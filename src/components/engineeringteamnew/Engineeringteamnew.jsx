...
import director_data from "@/data/fabrication_director_data";
import team_data from "@/data/fabrication_team_data";

function Engineering_Team_New() {
  return (
...
export default Engineering_Team_New;
