...
const footer_data = {
  logo: "https://res.cloudinary.com/dgtk4rthy/image/upload/v1734349340/FHGROUPOC/LOGOS/zfq9wbqmxdxjo1qqrcoi.png ",
  email: `info@fhgroupoc.com`,
  phone1: "+97 152 141 7285",
  phone2: "+92 331 444 7077",
  location1: `4th Floor, Al-Rasis Center, Al Baraha Street 1, Sector, Dubai-UAE.`,
  location2: `276-L Johar Town, Near Expo Center, Lahore Pakistan`,
...
const FooterOne = () => {
  return (
    <>
      <footer className="cs_footer cs_primary_bg all_center_m">
        <div className="cs_height_150 cs_height_lg_60"></div>
        <div className="container">
          <div className="row">
            <div className="col-lg-5 ">
              <div className="cs_footer_info">
                <img src={logo} alt="FH GROUP - ONE STEP SOLUTION" />
                <p>{footer_info}</p>
                <a
                  href={`mailto:${email}`}
            ...
            <div className="col-lg-6  offset-lg-1">
              <div style={{ background: "" }} className="cs_footer_social">
                <SocialLinks />
              </div>
              ...
              <div className="cs_height_40 cs_height_lg_55"></div>
              <div
                style={{
                  color: "#E2E2E2",
                  fontSize: "20px",
