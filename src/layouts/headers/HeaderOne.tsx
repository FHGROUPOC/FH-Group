...
import logo from "@/ass ets/img/logo.svg";
          ...
          <div className="container">
            <div className="cs_main_header_in">
              ...
              <div className="cs_main_header_right">
                ...
                {!session && (
                  <div className="profile_login_btn mx-2 hide_d_m_hide">
                    <a href="/login">
                      <CiLogin /> Log in
                    </a>
                  </div>
                ...
                {session && (
                  <Popup
                    trigger={
                      <Image
                        ...
                        src={
                          session?.user?.image ||
                          "https://res.cloudinary.com/dgtk4rthy/image/upload/v1734349339/FHGROUPOC/LOGOS/vuxagfvistorxnaoqnop.png"
                        }
                        alt=""
                      />
                    }
                  ...
                  >
                    <div className="profile_logout_btn">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-4 ">
              <div className="cs_box_two">
                <div>
                  <div style={{fontSize:"22px", fontWeight:"700",marginBottom:"20px", fontFamily:"Inter Tight, sans-serif"}} className="color_white">UAE</div>
                  <p>
                    <svg
                      width="14"
                      height="18"
                  ...
                  <div style={{fontSize:"22px", fontWeight:"700",marginBottom:"20px", fontFamily:"Inter Tight, sans-serif"}} className="cs_phone_number">
                    <a href="tel:+971521417285">
                      ...
                      <span className="ms-2">+97 152 141 7285</span>
                    </a>
                  </div>
                  <div className="cs_height_30 cs_height_lg_60"></div>
                  <div style={{fontSize:"22px", fontWeight:"700",marginBottom:"20px", fontFamily:"Inter Tight, sans-serif"}} className="color_white">PAK</div>
                  <p>
                    <svg
                      width="14"
                      height="18"
                  ...
                  <div style={{fontSize:"22px", fontWeight:"700",marginBottom:"20px", fontFamily:"Inter Tight, sans-serif"}} className="cs_phone_number">
                    <a href="tel:+923314447077">
                      ...
                      <span className="ms-2">+92 331 444 7077</span>
                    </a>
                  </div>
                  <div className="cs_height_30 cs_height_lg_60"></div>
                  ...
                  <ul className="cs_social_link">
                    <li>
                      <a
                        target="_blank"
                        href="https://www.facebook.com/fhgroupofc"
                      >
                        Facebook
                      </a>
                    </li>
                    <li>
                      <a
                        target="_blank"
                        href="https://www.linkedin.com/company/fhgroupoc/"
                      >
                        Linkedin
                      </a>
                    </li>
                    <li>
                      <a
                        target="_blank"
                        href="https://www.instagram.com/fhgroupofcompany/"
                      >
                        Instagram
                      </a>
                    </li>
                    <li>
                      <a
                        target="_blank"
                        href="https://www.pinterest.com/fhgroupoc/"
                      >
                        Pinterest
                      </a>
                    </li>
                  ...
                  <div className="h2" style={{ fontSize: "55px" }}>
                    <a
                      href="mailto:info@fhgroupoc.com"
                      className="cs_primary_font cs_text_btn"
                    >
                      <span className="cs_black">info@fhgroupoc.com</span>
                    </a>
                  </div>
                </div>
              </div>
