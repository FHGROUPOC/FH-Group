...
import MobileMenu from "./FabMobileMenu";
              ...
              <div className="cs_main_header_left">
                ...
                <Link className="cs_site_branding logo-white" href="/">
                  <img
                    ...
                    alt="FH GROUP - ONE STEP SOLUTION White Logo"
                  />
                </Link>
              </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-4 ">
              <div className="cs_box_two">
                <div>
                  <h6 className="color_white">UAE</h6>
                  <p>
                    <svg
                      width="14"
                      height="18"
                  ...
                  <h6 className="color_white">PAK</h6>
                  <p>
                    <svg
                      width="14"
                      height="18"
